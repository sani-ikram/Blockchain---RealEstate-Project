...
//    @dev Approves another address to transfer the given token ID
    ...
    function _mint(address to, uint256 tokenId) internal returns (uint256) {
        ...
        return _ownedTokensCount[to].increment();
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI(string memory tokenuribase, uint256 tokenId) internal returns (string memory){
...
contract ERC721Mintable is Ownable, ERC721Metadata {
    ...
    //string baseTokenURI = tokenURI(tokenId);
    constructor () public {
