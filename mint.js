  ...
  /*if (FACTORY_CONTRACT_ADDRESS) {
   ...
   //for (var i = 0; i < NUM_CREATURES; i++) {
      const result = await nftContract.methods
        .mint(OWNER_ADDRESS, 85 , "https://my-json-server.typicode.com/sani-ikram/Blockchain---RealEstate-Project/tokens/")
        .send({ from: OWNER_ADDRESS });

      console.log("Minted creature. Transaction: " + result.transactionHash);
        
      const result1 = await nftContract.methods
        .setTokenURI("https://my-json-server.typicode.com/sani-ikram/Blockchain---RealEstate-Project/tokens/",85)
        .call({ from: OWNER_ADDRESS });
       const  metadata_url1 = "https://my-json-server.typicode.com/sani-ikram/Blockchain---RealEstate-Project/tokens/1";
      
        var metadata_url = JSON.stringify(result1);
       console.log(metadata_url1);
